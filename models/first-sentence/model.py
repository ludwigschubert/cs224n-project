...
for dataset_path, train_dataset_name in zip(dataset_paths, dataset_names):
  for test_dataset_name in dataset_names:
    ...
    if exists(dataset_file_path):
      ...
      predictions_folder_path = "../../evaluation/first-sentence_" + train_dataset_name + "_" + test_dataset_name
